...
class BusinessImportRunLogController extends Controller
{
    ...
    public function store(Request $request)
    {
        $report = $request->validate([
            ...
            'command' => ['required', Rule::in(['research', 'import', 'run', 'remove-closed-businesses'])],
            ...
            'closed' => ['sometimes', 'integer', 'min:0'],
            ...
            'osm_progress' => ['sometimes', 'array:release,total,scanned,remaining,closed,invalid,pending,failed,review'],
            'osm_progress.release' => ['required_with:osm_progress', 'string', 'max:255'],
            'osm_progress.total' => ['required_with:osm_progress', 'integer', 'min:0'],
            'osm_progress.scanned' => ['required_with:osm_progress', 'integer', 'min:0', 'lte:osm_progress.total'],
            'osm_progress.remaining' => ['required_with:osm_progress', 'integer', 'min:0', 'lte:osm_progress.total'],
            'osm_progress.closed' => ['required_with:osm_progress', 'integer', 'min:0'],
            'osm_progress.invalid' => ['required_with:osm_progress', 'integer', 'min:0'],
            'osm_progress.pending' => ['required_with:osm_progress', 'integer', 'min:0'],
            'osm_progress.failed' => ['required_with:osm_progress', 'integer', 'min:0'],
            'osm_progress.review' => ['required_with:osm_progress', 'integer', 'min:0'],
            'closed_businesses_progress' => ['sometimes', 'array:snapshot_id,release,total,scanned,closed,invalid_evidence,would_remove,removed,already_removed,protected_claimed,review_required,unmatched,failed'],
            'closed_businesses_progress.snapshot_id' => ['required_with:closed_businesses_progress', 'string', 'max:255'],
            'closed_businesses_progress.release' => ['required_with:closed_businesses_progress', 'string', 'max:255'],
            'closed_businesses_progress.total' => ['required_with:closed_businesses_progress', 'integer', 'min:0'],
            'closed_businesses_progress.scanned' => ['required_with:closed_businesses_progress', 'integer', 'min:0', 'lte:closed_businesses_progress.total'],
            'closed_businesses_progress.closed' => ['required_with:closed_businesses_progress', 'integer', 'min:0'],
            'closed_businesses_progress.invalid_evidence' => ['required_with:closed_businesses_progress', 'integer', 'min:0'],
            'closed_businesses_progress.would_remove' => ['required_with:closed_businesses_progress', 'integer', 'min:0'],
            'closed_businesses_progress.removed' => ['required_with:closed_businesses_progress', 'integer', 'min:0'],
            'closed_businesses_progress.already_removed' => ['required_with:closed_businesses_progress', 'integer', 'min:0'],
            'closed_businesses_progress.protected_claimed' => ['required_with:closed_businesses_progress', 'integer', 'min:0'],
            'closed_businesses_progress.review_required' => ['required_with:closed_businesses_progress', 'integer', 'min:0'],
            'closed_businesses_progress.unmatched' => ['required_with:closed_businesses_progress', 'integer', 'min:0'],
            'closed_businesses_progress.failed' => ['required_with:closed_businesses_progress', 'integer', 'min:0'],
