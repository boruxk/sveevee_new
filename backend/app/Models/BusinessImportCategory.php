...
class BusinessImportCategory extends Model
{
    public $timestamps = false;

    protected $fillable = ['provider', 'value_hash', 'raw_value', 'label', 'first_source_id', 'example_page_id', 'first_seen_at', 'last_seen_at', 'mapped_category_key'];
