    ...
    private static function rawGroups(): array
    {
        ...
        self::$groups = [
            ...
            self::group('home_renovation_building', '#f97316', $businessServices, [
                ...
                self::topic('home_renovation_building.architecture_engineering', 'home-renovation-building-architecture-engineering', [], $business),
                self::topic('home_renovation_building.elevators', 'home-renovation-building-elevators', [], $business),
                self::topic('home_renovation_building.fire_safety', 'home-renovation-building-fire-safety', [], $business),
                self::topic('home_renovation_building.home_inspection', 'home-renovation-building-home-inspection', [], $business),
                self::topic('home_renovation_building.pools', 'home-renovation-building-pools', [], $business),
                self::topic('home_renovation_building.solar_energy', 'home-renovation-building-solar-energy', [], $business),
                self::topic('home_renovation_building.fireplaces', 'home-renovation-building-fireplaces', [], $business),
            ]),
            self::group('food_hospitality', '#ef4444', $businessProducts, [
                ...
                self::topic('food_catering.fish_stores', 'food-catering-fish-stores', [], $business),
                ...
                self::topic('food_catering.beverage_stores', 'food-catering-beverage-stores', [], $business),
                self::topic('food_catering.desserts_ice_cream', 'food-catering-desserts-ice-cream', [], $business),
                self::topic('food_catering.greengrocers', 'food-catering-greengrocers', [], $business),
                self::topic('food_catering.specialty_food', 'food-catering-specialty-food', [], $business),
            ]),
            self::group('shopping_retail', '#0891b2', $businessProducts, [
                ...
                self::topic('shopping_retail.adult_stores', 'shopping-retail-adult-stores', [], $business),
                self::topic('shopping_retail.cosmetics_stores', 'shopping-retail-cosmetics-stores', [], $business),
                self::topic('shopping_retail.crafts_hobbies', 'shopping-retail-crafts-hobbies', [], $business),
                self::topic('shopping_retail.firearms', 'shopping-retail-firearms', [], $business),
                self::topic('shopping_retail.garden_centers', 'shopping-retail-garden-centers', [], $business),
                self::topic('shopping_retail.general_stores', 'shopping-retail-general-stores', [], $business),
                self::topic('shopping_retail.hardware_building', 'shopping-retail-hardware-building', [], $business),
                self::topic('shopping_retail.lighting_electrical', 'shopping-retail-lighting-electrical', [], $business),
                self::topic('shopping_retail.markets_malls', 'shopping-retail-markets-malls', [], $business),
                self::topic('shopping_retail.musical_instruments', 'shopping-retail-musical-instruments', [], $business),
                self::topic('shopping_retail.optical', 'shopping-retail-optical', [], $business),
                self::topic('shopping_retail.second_hand_antiques', 'shopping-retail-second-hand-antiques', [], $business),
                self::topic('shopping_retail.sewing_textiles', 'shopping-retail-sewing-textiles', [], $business),
                self::topic('shopping_retail.tobacco', 'shopping-retail-tobacco', [], $business),
            ]),
            self::group('beauty_wellness', '#e11d48', $businessServices, [
                ...
                self::topic('beauty_personal_care.fitness_studios', 'beauty-personal-care-fitness-studios', [], $business),
                self::topic('beauty_personal_care.tattoo_piercing', 'beauty-personal-care-tattoo-piercing', [], $business),
                self::topic('beauty_personal_care.yoga_pilates', 'beauty-personal-care-yoga-pilates', [], $business),
                self::topic('beauty_personal_care.image_consulting', 'beauty-personal-care-image-consulting', [], $business),
            ]),
            self::group('health_care', '#16a34a', $businessServices, [
                ...
                self::topic('health_care.disability_support', 'health-care-disability-support', [], $business),
                self::topic('health_care.emergency_care', 'health-care-emergency-care', [], $business),
                self::topic('health_care.hospitals', 'health-care-hospitals', [], $business),
                self::topic('health_care.medical_labs', 'health-care-medical-labs', [], $business),
            ]),
            self::group('education_kids', '#7c3aed', [self::SCOPE_BUSINESS_PAGES, self::SCOPE_SERVICES, self::SCOPE_EVENTS], [
                ...
                self::topic('education_courses.camps', 'education-courses-camps', [], $business),
                self::topic('education_courses.colleges_universities', 'education-courses-colleges-universities', [], $business),
                self::topic('education_courses.schools', 'education-courses-schools', [], $business),
                self::topic('education_courses.sports_dance_classes', 'education-courses-sports-dance-classes', [], $business),
            ]),
            self::group('events_entertainment', '#f54291', [self::SCOPE_BUSINESS_PAGES, self::SCOPE_SERVICES, self::SCOPE_EVENTS], [
                ...
                self::topic('events_entertainment.adult_entertainment', 'events-entertainment-adult-entertainment', [], $business),
                self::topic('events_entertainment.amusement_venues', 'events-entertainment-amusement-venues', [], $business),
                self::topic('events_entertainment.gaming_lottery', 'events-entertainment-gaming-lottery', [], $business),
                self::topic('events_entertainment.movie_theaters', 'events-entertainment-movie-theaters', [], $business),
                self::topic('events_entertainment.museums_galleries', 'events-entertainment-museums-galleries', [], $business),
                self::topic('events_entertainment.nightlife', 'events-entertainment-nightlife', [], $business),
                self::topic('events_entertainment.recording_studios', 'events-entertainment-recording-studios', [], $business),
                self::topic('events_entertainment.sports_facilities', 'events-entertainment-sports-facilities', [], $business),
                self::topic('events_entertainment.theaters_music', 'events-entertainment-theaters-music', [], $business),
            ]),
            self::group('auto_transport', '#0284c7', $businessServices, [
                ...
                self::topic('auto_transport.boat_aircraft_services', 'auto-transport-boat-aircraft-services', [], $business),
                self::topic('auto_transport.car_wash', 'auto-transport-car-wash', [], $business),
                self::topic('auto_transport.freight_logistics', 'auto-transport-freight-logistics', [], $business),
                self::topic('auto_transport.fuel_stations', 'auto-transport-fuel-stations', [], $business),
                self::topic('auto_transport.parking', 'auto-transport-parking', [], $business),
                self::topic('auto_transport.postal_services', 'auto-transport-postal-services', [], $business),
                self::topic('auto_transport.vehicle_inspection', 'auto-transport-vehicle-inspection', [], $business),
                self::topic('auto_transport.vehicle_sales', 'auto-transport-vehicle-sales', [], $business),
            ]),
            self::group('professional_business', '#7c2d12', $businessServices, [
                ...
                self::topic('professional_business.coworking', 'professional-business-coworking', [], $business),
                self::topic('professional_business.equipment_rental', 'professional-business-equipment-rental', [], $business),
                self::topic('professional_business.funeral_services', 'professional-business-funeral-services', [], $business),
                self::topic('professional_business.laundry', 'professional-business-laundry', [], $business),
                self::topic('professional_business.print_signage', 'professional-business-print-signage', [], $business),
                self::topic('professional_business.private_investigators', 'professional-business-private-investigators', [], $business),
                self::topic('professional_business.property_management', 'professional-business-property-management', [], $business),
                self::topic('professional_business.publishing_media', 'professional-business-publishing-media', [], $business),
                self::topic('professional_business.recruiting', 'professional-business-recruiting', [], $business),
                self::topic('professional_business.scientific_research', 'professional-business-scientific-research', [], $business),
                self::topic('professional_business.spiritual_advice', 'professional-business-spiritual-advice', [], $business),
                self::topic('professional_business.tailoring_shoe_repair', 'professional-business-tailoring-shoe-repair', [], $business),
                self::topic('professional_business.telecom', 'professional-business-telecom', [], $business),
                self::topic('professional_business.wholesale_distribution', 'professional-business-wholesale-distribution', [], $business),
                self::topic('professional_business.genealogy', 'professional-business-genealogy', [], $business),
            ]),
            ...
            self::group('pets', '#65a30d', [self::SCOPE_USERS, self::SCOPE_BUSINESS_PAGES, self::SCOPE_SERVICES, self::SCOPE_PRODUCTS], [
                ...
                self::topic('pets.breeders', 'pets-breeders', [], $business),
            ]),
            self::group('travel_leisure', '#0f766e', [self::SCOPE_BUSINESS_PAGES, self::SCOPE_SERVICES, self::SCOPE_EVENTS], [
                ...
                self::topic('travel_leisure.air_sea_transport', 'travel-leisure-air-sea-transport', [], $business),
                self::topic('travel_leisure.boats_water_sports', 'travel-leisure-boats-water-sports', [], $business),
                self::topic('travel_leisure.campsites', 'travel-leisure-campsites', [], $business),
                self::topic('travel_leisure.tourist_attractions', 'travel-leisure-tourist-attractions', [], $business),
                self::topic('travel_leisure.zoos_aquariums', 'travel-leisure-zoos-aquariums', [], $business),
            ]),
            self::group('industry_agriculture', '#64748b', $business, [
                self::topic('industry_agriculture.agriculture_services', 'industry-agriculture-agriculture-services', [], $business),
                self::topic('industry_agriculture.beverage_production', 'industry-agriculture-beverage-production', [], $business),
                self::topic('industry_agriculture.energy_utilities', 'industry-agriculture-energy-utilities', [], $business),
                self::topic('industry_agriculture.farms', 'industry-agriculture-farms', [], $business),
                self::topic('industry_agriculture.food_manufacturing', 'industry-agriculture-food-manufacturing', [], $business),
                self::topic('industry_agriculture.food_wholesale', 'industry-agriculture-food-wholesale', [], $business),
                self::topic('industry_agriculture.industrial_equipment', 'industry-agriculture-industrial-equipment', [], $business),
                self::topic('industry_agriculture.manufacturing', 'industry-agriculture-manufacturing', [], $business),
                self::topic('industry_agriculture.materials', 'industry-agriculture-materials', [], $business),
                self::topic('industry_agriculture.metalworking', 'industry-agriculture-metalworking', [], $business),
                self::topic('industry_agriculture.textile_manufacturing', 'industry-agriculture-textile-manufacturing', [], $business),
                self::topic('industry_agriculture.warehousing', 'industry-agriculture-warehousing', [], $business),
            ]),
