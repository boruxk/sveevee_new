...
final class WorkerPaths
{
    public static function resolve(array $storage, string $root): array
    {
        ...
        if (! is_string($namespace) || ! in_array($namespace, ['', 'tel-aviv', 'overture', 'foursquare', 'osm'], true)) {
            throw new RuntimeException('storage.data_subdirectory must be empty, tel-aviv, overture, foursquare or osm.');
        }
