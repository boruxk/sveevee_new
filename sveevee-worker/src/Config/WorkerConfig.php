...
final class WorkerConfig
{
    ...
    {
        if ($this->bool('sources.osm_places.enabled') && $this->get('sources.osm_places.import_mode') !== 'all_records') {
            throw new RuntimeException('OpenStreetMap requires import_mode all_records.');
        }
