export default {
	...
	ads: {
		...
		activeLimitReached: 'Vous avez deja atteint la limite de {limit} annonces actives.',
		...
		timer: {
			...
			hourShort: 'h',
			minuteShort: 'min',
			expiredRedirect: 'Cette annonce a expire. Vous avez ete redirige vers le catalogue des annonces.'
		}
	},
	adCategories: {
		groups: {
	...
	products: {
		...
		limitReached: 'Cette page entreprise a deja atteint la limite de {limit} produits.',
	...
	events: {
		...
		limitReached: 'Cette page communautaire a deja atteint la limite de {limit} evenements futurs.',
	...
	admin: {
		...
		settings: {
			...
			adsTitle: 'Annonces',
			adsIntro: 'Gerez la duree des nouvelles annonces, les limites actives et la suppression definitive.',
			adVisibility: 'Duree de visibilite par defaut',
			privateAdLimit: 'Annonces privees actives par utilisateur',
			pageAdLimit: 'Annonces actives par page',
			adPurgeDelay: 'Suppression definitive apres expiration',
			days: 'jours',
			adsUnit: 'annonces',
			labelsTitle: 'Labels automatiques',
			labelsIntro: 'Ces seuils s appliquent immediatement aux produits existants et nouveaux.',
			newLabelDays: 'Duree du label Nouveau',
			popularViews: 'Populaire a partir de vues',
			popularContacts: 'Populaire a partir de contacts',
			ratingAverage: 'Moyenne minimale Tres bien note',
			ratingCount: 'Nombre minimal d avis',
			views: 'vues',
			contacts: 'contacts',
			ratings: 'avis',
			chatTitle: 'Chat et spam',
			chatIntro: 'Definissez les limites de contacts et de messages sans modifier la regle de reponse.',
			newRecipients: 'Nouveaux interlocuteurs',
			messagesPerMinute: 'Messages',
			perDay: 'par jour',
			perMinute: 'par minute',
			moderationTitle: 'Contenu et moderation',
			moderationIntro: 'Limitez le contenu des pages et gerez des mots ou expressions bloques supplementaires.',
			productLimit: 'Produits par page d entreprise',
			eventLimit: 'Evenements futurs par page communautaire',
			products: 'produits',
			events: 'evenements',
			blockedTerms: 'Mots et expressions bloques',
			blockedTermsIntro: 'La protection integree reste active. Ces termes supplementaires sont verifies dans toutes les langues.',
			wordOrPhrase: 'Mot ou expression',
			language: 'Etiquette de langue',
			allLanguages: 'Toutes les langues',
			activeTerm: 'Actif',
			addTerm: 'Ajouter un terme bloque',
			noBlockedTerms: 'Aucun terme bloque supplementaire.',
			termAdded: 'Terme bloque ajoute.',
			termSaved: 'Terme bloque enregistre.',
			termSaveFailed: 'Impossible d enregistrer le terme bloque.',
			termDeleteConfirm: 'Supprimer "{term}" des termes bloques ?',
			termDeleted: 'Terme bloque supprime.',
			termDeleteFailed: 'Impossible de supprimer le terme bloque.',
			platformTitle: 'Plateforme',
			platformIntro: 'Gerez le mode maintenance et les categories mises en avant sur Sveevee.',
			maintenanceMode: 'Mode maintenance',
			maintenanceHint: 'Les visiteurs voient une page noindex et les requetes API ordinaires recoivent une reponse 503.',
			maintenanceMessage: 'Message de maintenance',
			maintenanceConfirm: 'Activer le mode maintenance ? Les visiteurs et utilisateurs ordinaires perdront temporairement l acces.',
			popularCategories: 'Categories populaires',
			popularCategoriesIntro: 'Choisissez et classez jusqu a 12 categories. Une liste vide masque le bloc.',
			...
			popularEmpty: 'Aucune categorie populaire selectionnee.'
		}
	},
	maintenance: {
		title: 'Nous revenons bientot',
		defaultMessage: 'Sveevee est actuellement en maintenance. Veuillez reessayer prochainement.',
		retry: 'Reessayer',
