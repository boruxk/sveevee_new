export default {
	...
	market: {
		kicker: 'Marche',
		cityTitle: 'Produits et annonces a {city}',
		topicTitle: '{topic} a {city}',
		citySeoTitle: 'Marche a {city} - acheter et vendre',
		topicSeoTitle: '{topic} a {city} - acheter et vendre',
		cityDescription: 'Achetez et vendez a {city}. Trouvez meubles, electronique, velos, ordinateurs, produits enfant et autres annonces locales de personnes et commerces locaux.',
		topicDescription: 'Trouvez {topic} a {city}. Parcourez les produits, annonces locales et vendeurs sur sveevee.',
		typeTitle: 'Types populaires',
		relatedTypes: 'Types lies',
	...
	seo: {
		...
		landingDescription: 'Trouvez entreprises, professionnels, boutiques, produits, services et annonces locales par ville et quartier. Sur Sveevee, vous pouvez decouvrir des entreprises locales, acheter, vendre et contacter directement.',
		...
		productFallbackDescription: 'Consultez un produit local a vendre sur sveevee.',
		businessPageTitle: '{name} a {city} - services, avis et contact',
		businessPageDescription: '{name} - {category} a {city}{neighborhood}. Consultez services, horaires, notes et coordonnees sur sveevee.',
		productPageTitle: '{name} a {city} - prix et details du produit',
		productPageDescription: '{name} a {city} pour {price}. Consultez details du produit, vendeur, lieu, disponibilite et options de contact sur sveevee.',
