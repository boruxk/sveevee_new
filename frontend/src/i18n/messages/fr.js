export default {
	...
	market: {
		kicker: 'Marche d occasion',
		cityTitle: 'Produits d occasion et annonces a {city}',
		topicTitle: '{topic} a {city}',
		citySeoTitle: 'Marche d occasion a {city} - acheter et vendre',
		topicSeoTitle: '{topic} a {city} - acheter et vendre',
		cityDescription: 'Achetez et vendez a {city}. Trouvez meubles, electronique, velos, ordinateurs, produits enfant et autres annonces d occasion de personnes et commerces locaux.',
		topicDescription: 'Trouvez {topic} a {city}. Parcourez les produits d occasion, annonces locales et vendeurs sur sveevee.',
		typeTitle: 'Types populaires',
		relatedTypes: 'Types lies',
		productsTitle: 'Produits',
		resultsCount: '{count} resultats',
		viewSeller: 'Voir le vendeur',
		empty: 'Aucun produit d occasion pour le moment.'
	},
	seo: {
		...
		landingDescription: 'Trouvez entreprises, professionnels, boutiques, produits, services et annonces d occasion par ville et quartier. Sur Sveevee, vous pouvez decouvrir des entreprises locales, acheter, vendre et contacter directement.',
		...
		marketTitle: 'Marche d occasion',
		marketDescription: 'Parcourez les produits d occasion par ville et type de produit sur sveevee.',
		loginTitle: 'Connexion',
