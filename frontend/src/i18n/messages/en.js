export default {
	businessPro: {
		...
		privateTitle: 'Private Pro',
		privateIntro: 'Highlight your personal ads with Private Pro.',
		privateAccountPlan: 'For your personal account. No business page is required.',
		featuredAd: 'Feature this ad',
		featuredAdDescription: 'Highlight this ad and give it priority within matching results.',
		featuredAdRequiresPlan: 'Activate this option with Private Pro or Business Pro.',
		featuredAdPageRequired: 'Business ads require Business Pro for the selected business page.',
		featuredAdUnavailable: 'This paid feature is currently unavailable.',
		featuredAdBadge: 'Featured',
		planColumn: 'Plan',
		currentPlanNotice: 'You already have a Pro subscription. Manage your current plan to view its status.',
		viewDetails: 'View details',
		buy: 'Buy',
		manage: 'Manage subscription',
		profileIntro: 'A monthly subscription for one business page.',
		close: 'Close',
		availableLater: 'Purchasing will be available later.',
		title: 'Business Pro',
		privatePreview: 'Private preview',
		testMode: 'Test mode',
		productionMode: 'Live mode',
		pricePerMonth: '{price} / month',
		accountPlan: 'One subscription for your account, including one selected business page.',
		includedPage: 'Included business page',
		noBusinessPage: 'Create a business page before starting a subscription.',
		createBusiness: 'Create business page',
		testNotice: 'This is a test subscription. Use Cardcom test payment details on the hosted payment page.',
		billingConsent: 'I agree to automatic billing of {price} every month until I cancel renewal.',
		cancelTerms: 'Cancellation stops the next renewal. Access remains available until the end of the paid period.',
		checkout: 'Continue to Cardcom',
		checkoutUnavailable: 'Test checkout is not configured yet. Please try again later.',
		checkoutFailed: 'Checkout could not be started. Please try again.',
		offerChanged: 'The price changed. Review the updated price and confirm your consent again.',
		endsOn: 'Access ends on {date}. Renewal is cancelled.',
		renewsOn: 'Next renewal: {date}.',
		cancelRenewal: 'Cancel renewal',
		confirmCancel: 'Confirm cancellation',
		keepSubscription: 'Keep subscription',
		cancelFailed: 'Renewal could not be cancelled. Please try again.',
		features: 'Pro features',
		noFeatures: 'Additional features will appear here once they are defined.',
		subscriptionRequired: 'Activate this feature with a suitable paid Pro plan.',
		notAvailable: 'This feature is not available yet.',
		available: 'Available',
		locked: 'Unavailable',
		refresh: 'Refresh',
		retry: 'Try again',
		loadFailed: 'Pro plans could not be loaded. Please try again.',
		verifyTitle: 'Payment verification',
		verifyIntro: 'We check the payment status with Cardcom before enabling the subscription.',
		verifyFailed: 'The payment status could not be verified yet. Please check again.',
		paymentStatus: 'Status',
		accessActive: 'The subscription is active.',
		verificationPending: 'Subscription access is not active yet. You can check the payment status again.',
		verifyAgain: 'Check payment status',
		backToPlan: 'Back to Pro plans',
		openPreview: 'Open private preview',
		offerPrice: 'Subscription price',
		monthlyPriceIls: 'Monthly price (ILS)',
		futureContractsOnly: 'Price changes apply to future purchases. Existing subscriptions keep their agreed price.',
		priceRange: 'Enter a price between ₪1 and ₪10,000 with up to two decimal places.',
		save: 'Save',
		saved: 'Saved.',
	...
	community: {
		feedChanged: 'The featured ads changed. Results have been refreshed.',
		lastReply: 'Last reply: {date}',
		profileArea: 'Your area: {location}',
		allAreas: 'All areas',
		nearby: 'Nearby',
		nearbyIntro: 'Questions, recommendations, ads and events in your area.',
		feedIntro: 'Discover what is happening nearby.',
		filters: 'Choose your area',
		city: 'City',
		...
		followSelection: 'Follow this area and category',
		signIn: 'Sign in to participate',
		signInHint: 'Sign in to ask questions, reply and follow updates.',
		emptyFeed: 'No updates here yet.',
		loadFailed: 'Updates could not be loaded.',
		retry: 'Try again',
		loadMore: 'Load more',
		questionTitle: 'Your question',
		questionBody: 'Details',
		questionIntro: 'Ask for local advice or recommendations.',
		...
		deleteQuestionMessage: 'The question and its replies will be removed.',
		deleted: 'Question deleted.',
		questionUnavailable: 'This question is unavailable.',
		backNearby: 'Back to nearby',
		myQuestions: 'My questions',
		noQuestions: 'You have not asked any questions yet.',
		replies: 'Replies',
		notifications: 'Notifications',
		noSubscriptions: 'You are not following any pages or topics yet.',
		removeSubscription: 'Unfollow',
		subscriptionsFailed: 'Subscriptions could not be loaded.',
		...
		noQuestionsYet: 'No questions yet. Ask the first question.',
		questionsFailed: 'Questions could not be loaded.',
		questionSaveFailed: 'Your question could not be sent. Your draft has been kept.',
		itemUnavailable: 'This item is unavailable.',
		commentsFailed: 'Replies could not be loaded.',
		commentSaveFailed: 'Your reply could not be sent. Your draft has been kept.',
		member: 'Member',
		ownerReply: 'Owner',
		reply: 'Reply',
		...
		unmarkHelpful: 'Remove helpful mark',
		recommendedBusiness: 'Recommended business',
		recommendBusiness: 'Recommend a business (optional)',
		recommendBusinessHint: 'Search by business name to attach its page.',
		noMatchingBusiness: 'Type at least two characters to find a business.',
		report: 'Report',
		reportReason: 'Reason',
		sendReport: 'Send report',
		reportSent: 'Your report was sent for review.',
		moderation: 'Community reports',
		reportsFailed: 'Reports could not be loaded.',
		...
		previous: 'Previous',
		next: 'Next',
		notificationReplyTitle: 'New reply',
		notificationReplyBody: '{actor} replied to {title}.',
		notificationHelpfulTitle: 'Your reply helped',
		notificationHelpfulBody: '{actor} marked your reply to {title} as helpful.',
		notificationLikeTitle: 'New likes',
		notificationLikeBody: 'Your contribution to {title} received a like.',
		notificationActivityTitle: 'New update nearby',
		notificationActivityBody: 'New in your subscriptions: {title}.',
		reportStatus: {
			pending: 'Pending',
			dismissed: 'Dismissed',
			hidden: 'Hidden',
	...
	chat: {
		...
		guestLinksNotAllowed: 'Links are not allowed in guest chats. Remove them to continue.',
		guestLinksHint: 'Guest messages cannot contain links.',
		supportPendingReply: 'Please wait for a reply from support before sending more messages.',
		...
		deleteMessage: 'Choose how to delete your chat with {name}.',
		deleteForMe: 'Delete for me',
		deleteForEveryone: 'Delete for everyone',
		deleteSuccess: 'Chat deleted.',
		deleteFailed: 'Chat could not be deleted.',
		title: 'Chat',
		empty: 'Choose a chat on the left.',
		placeholder: 'Write a message',
		humanSupport: 'Human support',
		supportWidgetTitle: 'sveevee · Human support',
		supportTitle: 'Human support',
		supportOpen: 'Open sveevee support chat',
	...
	pages: {
		...
		adopted: 'An existing business page was assigned to you and saved with your details.',
		claimConflictTitle: 'Ownership review pending',
		claimConflictPending: 'Your ownership request and page details were sent for administrator review. You can continue editing this form.',
	...
	admin: {
		...
		claimCurrentOwner: 'Current owner',
		claimRequester: 'Requester',
		claimMatchedOn: 'Matching fields',
		claimCompareData: 'Compare business details',
		claimMultipleMatches: 'This request matches {count} pages. Assigning this page closes the other pending matches in the request.',
		claimDataField: 'Field',
		claimCurrentData: 'Current page',
		claimProposedData: 'Submitted details',
		claimDataChanged: 'Changed',
		claimFeatureEnabled: 'Enabled',
		claimFeatureDisabled: 'Disabled',
		claimKeepOwner: 'Keep the current owner',
		claimAssignRequester: 'Assign to the requester',
		claimRejectMatch: 'Reject this match',
		claimConflictKept: 'The existing ownership was kept.',
		claimMatchedFields: {
			name: 'Name',
			phone: 'Phone',
			email: 'Email',
		...
		landingPagesIntro: 'Public advertising and campaign pages for free business and community page offers.',
		landingPageLeadDescription: 'Lead form for Meta campaigns that creates an unclaimed business page and redirects visitors directly to it.',
		...
		statistics: {
			title: 'Statistics',
			leadPagesTitle: 'Pages created by Leads Page 001',
			leadPagesIntro: 'Business pages created through this lead campaign, including their original contact details and current ownership status.',
			total: 'Total created pages',
		...
		logs: {
			...
			types: {
				...
				removeClosedBusinesses: 'Remove closed businesses'
			},
			statuses: {
				success: 'Successful',
			...
			closedBusinessesSummary: '{removed} removed, {planned} would be removed, {review} for review, {unmatched} unmatched, {failed} failed',
		...
		userTableFailed: 'The user table could not be loaded. Please try again.',
		userPagesPagination: 'User pages pagination',
		retry: 'Try again',
		...
		settings: {
			...
			chatIntro: 'Set contact and message limits, including how many messages are allowed before a support reply.',
			newRecipients: 'New conversation partners',
			messagesPerMinute: 'Messages',
			supportMessagesBeforeReply: 'Messages before a support reply',
			supportMessagesBeforeReplyHint: 'After this many consecutive messages, users must wait for a support reply.',
	...
	businessLead: {
		...
		heroTitle: 'We will build your complete business page for free',
		benefitPrepared: 'We prepare the page for you',
		benefitIncluded: 'Including business details and contact options',
		...
		consent: 'I approve creating a public page with the business details and being contacted about this request.',
		...
		completionCreatedTitle: 'Your page is ready',
		completionCreatedGuestBody: 'You can register to manage it.',
		...
		completionExistingGuestBody: 'This page already exists on Sveevee. You can register to request ownership and manage it.',
		...
		completionFreeNote: 'Everything is free.',
	...
	pageClaim: {
		...
		replaceTitle: 'Replace existing business page?',
		replaceMessage: 'You already have the business page "{page}". If this claim is approved, that page and its content will be permanently deleted and replaced by "{target}".',
		replaceCurrentLabel: 'Current business page',
		replaceTargetLabel: 'Page you want to claim',
		replaceConfirm: 'Continue and replace',
	...
	seo: {
		...
		businessLandingDescription: 'Create a free Sveevee business page with products, services, public questions, followers, local ads, reviews, and chat without registration.',
	...
	promoLanding: {
		...
		business: {
			...
			subtitle: 'Create a public business page with products, services, offers, reviews, followers, public questions, and chat for visitors with or without an account.',
			...
			descriptionBody: 'Bring your price list, products, services, offers, reviews, and contact details together on one local page. Customers can follow your page for new ads, ask about products and services, recommend your business in Nearby, or contact you in private chat.',
			...
			functions: [
				...
				{ icon: 'design_services', title: 'Services', body: 'Clear service presentation before contact.', items: ['Service names and details', 'Local category context', 'Public service detail pages', 'Website links and browsing from the page'] },
				{ icon: 'chat_bubble', title: 'Product and service questions', body: 'Answer once so other visitors can read the details too.', items: ['Public Questions sections on product and service pages', 'Replies marked with an Owner badge', 'Notifications for questions and replies', 'Sign in to ask or reply'] },
				{ icon: 'campaign', title: 'Business ads', body: 'Local offers connected to the business.', items: ['Offers and announcements', 'Business badge on ad cards', 'Ads in the Nearby feed', 'Links back to the page'] },
				{ icon: 'public', title: 'Followers and notifications', body: 'Let customers follow your page and choose which updates to receive.', items: ['Follow from your business page', 'In-app notifications for new business ads', 'Notification settings and Unfollow in My subscriptions', 'Account required to follow'] },
				{ icon: 'groups', title: 'Recommendations in Nearby', body: 'Join local conversations where people look for recommendations.', items: ['Questions by city, neighborhood, and topic', 'Business recommendations linked to your page', 'Likes on ads and comments', 'Sign in to ask, reply, or like'] },
				...
				{ icon: 'forum', title: 'Direct contact', body: 'Let visitors contact your business, even without an account.', items: ['Separate business chat', 'Guest chat without registration', 'Register from chat to keep the conversation', 'Messages and replies under the business identity', 'WhatsApp, phone, and email', 'Maps and social links'] },
