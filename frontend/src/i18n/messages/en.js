export default {
	...
	market: {
		kicker: 'Second hand market',
		cityTitle: 'Second hand products and local listings in {city}',
		topicTitle: '{topic} in {city}',
		citySeoTitle: 'Second hand market in {city} - buy and sell',
		topicSeoTitle: '{topic} in {city} - buy and sell',
		cityDescription: 'Buy and sell in {city}. Find furniture, electronics, bicycles, computers, kids products, and more second hand listings from people and local businesses nearby.',
		topicDescription: 'Find {topic} in {city}. Browse second hand products, local listings, and sellers on sveevee.',
		typeTitle: 'Popular market types',
		relatedTypes: 'Related market types',
		productsTitle: 'Products',
		resultsCount: '{count} results',
		viewSeller: 'View seller',
		empty: 'No second hand products yet.'
	},
	seo: {
		...
		landingDescription: 'Find businesses, professionals, stores, products, services, and second hand ads by city and neighborhood. On sveevee you can discover local businesses, buy and sell, and contact people directly.',
		...
		marketDescription: 'Browse second hand products by city and type on sveevee.',
		loginTitle: 'Login',
