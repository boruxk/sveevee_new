export default {
	businessPro: {
		...
		features: 'Business Pro features',
		noFeatures: 'Additional features will appear here once they are defined.',
		subscriptionRequired: 'An active Business Pro subscription is required.',
		notAvailable: 'This feature is not available yet.',
		available: 'Available',
		locked: 'Unavailable',
		refresh: 'Refresh',
		retry: 'Try again',
		loadFailed: 'Business Pro could not be loaded. Please try again.',
		...
		backToPlan: 'Back to Business Pro',
