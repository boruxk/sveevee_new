export default {
	...
	seo: {
		...
		landingDescription: 'מצאו עסקים, בעלי מקצוע, חנויות, מוצרים, שירותים ומודעות מקומיות לפי עיר ושכונה. ב-Sveevee אפשר למצוא עסקים מקומיים, לקנות ולמכור וליצור קשר ישירות.',
