export default {
	...
	seo: {
		...
		landingDescription: 'sveevee עוזרת למצוא מודעות מקומיות, עמודי עסק, עמודי קהילה, מוצרים, שירותים, אירועים, דירוגים, אנשים קרובים וצ׳אט לפי עיר ושכונה.',
	...
	landing: {
		...
		contentBlocks: [
			...
			{
				title: 'עמודים ציבוריים לעסקים וקהילות',
				body: 'עסקים קטנים ויוזמות קהילתיות יכולים לשמור את כל המידע הציבורי במקום ברור אחד. עמוד עסק יכול להציג חנות עם מוצרים, מחירים, תמונות וקישורים לאתר המוכר. עמוד קהילה יכול להציג אירועים עם תאריך, שעה, שעת סיום וכתובת שנפתחת במפה. שני סוגי העמודים יכולים לכלול לוגו, באנר, פרטי קשר, שעות פתיחה, מודעות, דירוגים ותצוגה ציבורית.'
			},
			{
		...
		features: [
			...
			{
				icon: 'storefront',
				title: 'עמוד עסק ועמוד קהילה',
				body: 'כל משתמש יכול לפתוח עמוד עסק אחד ועמוד קהילה אחד עם תמונות, פרטי קשר, כתובת, שעות פתיחה ותצוגה ציבורית.'
			},
			{
				icon: 'inventory_2',
		...
		plans: [
			...
			},
			{
				...
				featured: true,
				features: ['עמוד עסק אחד', 'עמוד קהילה אחד', 'מוצרי חנות', 'אירועים קהילתיים', 'דירוגים וחוות דעת', 'מודעות עסק וקהילה']
			}
		]
	}
}
