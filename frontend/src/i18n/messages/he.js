export default {
	...
	market: {
		kicker: 'לוח יד שנייה',
		cityTitle: 'מוצרי יד שנייה ומודעות ב{city}',
		topicTitle: '{topic} ב{city}',
		citySeoTitle: 'לוח יד שנייה ב{city} - קנייה ומכירה',
		topicSeoTitle: '{topic} ב{city} - קנייה ומכירה',
		cityDescription: 'קונים ומוכרים ב{city}. מצאו ריהוט, מוצרי חשמל, אופניים, מחשבים, מוצרים לילדים ועוד מודעות יד שנייה מאנשים ועסקים באזור.',
		topicDescription: 'מצאו {topic} ב{city}. דפדפו במוצרי יד שנייה, מודעות מקומיות ומוכרים ב-sveevee.',
		typeTitle: 'סוגי מוצרים פופולריים',
		relatedTypes: 'סוגי מוצרים קשורים',
		productsTitle: 'מוצרים',
		resultsCount: '{count} תוצאות',
		viewSeller: 'צפייה במוכר',
		empty: 'עדיין אין מוצרי יד שנייה.'
	},
	seo: {
		...
		landingDescription: 'מצאו עסקים, בעלי מקצוע, חנויות, מוצרים, שירותים ומודעות יד שנייה לפי עיר ושכונה. ב-Sveevee אפשר למצוא עסקים מקומיים, לקנות ולמכור וליצור קשר ישירות.',
		...
		marketTitle: 'לוח יד שנייה',
		marketDescription: 'דפדפו במוצרי יד שנייה לפי עיר וסוג מוצר ב-sveevee.',
		loginTitle: 'כניסה',
