export default {
	...
	seo: {
		...
		landingTitle: 'SVEEVEE - מודעות מקומיות ועמודי שכונה',
		landingDescription: 'מצאו מודעות מקומיות, עמודי עסק, עמודי קהילה, מוצרי חנות, אירועים, דירוגים, אנשים קרובים וצאט לפי עיר ושכונה.',
