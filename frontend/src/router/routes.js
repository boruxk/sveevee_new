...
export default [
	{
		...
		children: [
			...
			{ path: 'nearby', name: 'nearby', component: () => import('@/pages/NearbyPage.vue'), meta: { seo: { titleKey: 'community.nearby', descriptionKey: 'community.feedIntro', robots: 'noindex,follow' } } },
			{ path: 'questions/:id', name: 'local-question', component: () => import('@/pages/QuestionDetailPage.vue'), meta: { seo: { titleKey: 'community.question', robots: 'noindex,follow' } } },
			{ path: 'services/:id', name: 'service-detail', component: () => import('@/pages/ServiceDetailPage.vue'), meta: { seo: { titleKey: 'businessServices.title', robots: 'noindex,follow' } } },
			{ path: 'events/:id', name: 'event-detail', component: () => import('@/pages/EventDetailPage.vue'), meta: { seo: { titleKey: 'events.eventsTitle', robots: 'noindex,follow' } } },
